...
import { test, userLogin, userRegister } from "../redux/slices/user/userSlice";
...
const SignIn: React.FC = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      const loginRes = await dispatch(userLogin(data))
      console.log("login Reas",loginRes)
    } catch (error) {}
  };
  return (
    <>
